...
export const Footer = () => {
	return (
		<footer className='p-5'>
			<hr className='mb-4' />
			<div className='flex flex-col gap-4 md:flex-row md:gap-0 md:justify-between text-zinc-800 items-center'>
				<p className='text-zinc-700 flex items-center justify-start gap-2 text-sm'>
